...
RUN python3 -m pip install --break-system-packages --force-reinstall azure-cli && \
    az version
...
RUN python3 -m pip install --break-system-packages --force-reinstall --extra-index-url https://kalderosllc.github.io/kald-devops/simple kald-devops && \
    kald-devops usage
